...
function MacroIndicator({
  ...
  const resolved = Modules.Fallbacks.resolveTarget(macro, profile, {
  ...
  const r = 26,
    circ = 2 * Math.PI * r,
    offset = circ * (1 - fill / 100);
  const u = NUTRIENT_UNITS[macro];
  return /*#__PURE__*/React.createElement("div", {
    "data-testid": testId,
    className: "liquid-glass rounded-3xl p-5 flex items-center gap-4",
    role: "progressbar",
    "aria-valuemin": 0,
    "aria-valuemax": 100,
    "aria-valuenow": fill,
    "aria-valuetext": `${pct}%`,
    "aria-label": `${label}: ${pct}% of daily target`
  }, /*#__PURE__*/React.createElement("div", {
    className: "relative",
    style: {
      width: 72,
    ...
    x2: "1",
    y2: "1"
  }, gradientStops)), /*#__PURE__*/React.createElement("circle", {
    cx: "32",
    cy: "32",
    r: r,
    fill: "none",
...
function LogDaySheet({
  ...
  if (wizardOpen) {
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "font-headline text-lg font-bold"
    }, wizardEdit ? "Edit Custom Food" : "New Custom Food"), /*#__PURE__*/React.createElement("button", {
      onClick: () => setWizardOpen(false),
      className: "p-1 hover:bg-on-surface/10 rounded-full transition"
    }, /*#__PURE__*/React.createElement(Icon, {
      name: "close",
      ...
      "data-testid": "custom-food-wizard"
    }, /*#__PURE__*/React.createElement("div", {
      ...
      "aria-label": "Emoji"
    })), wizardBarcode && /*#__PURE__*/React.createElement("div", {
      className: "flex items-center gap-2 bg-on-surface/5 rounded-xl px-4 py-2 text-xs text-on-surface-variant"
    }, /*#__PURE__*/React.createElement(Icon, {
      name: "qr_code_scanner",
      size: 16
    }), /*#__PURE__*/React.createElement("span", null, "Barcode Reference: ", wizardBarcode)), /*#__PURE__*/React.createElement("h3", {
      className: "font-headline text-sm font-semibold text-on-surface-variant"
    }, "Nutrients per serving"), /*#__PURE__*/React.createElement("div", {
      className: "grid grid-cols-2 gap-2"
    }, NUTRIENT_KEYS.map(k => /*#__PURE__*/React.createElement("div", {
      key: k,
      className: "flex items-center gap-2 bg-on-surface/5 rounded-xl px-3 py-2"
    }, /*#__PURE__*/React.createElement("label", {
      className: "text-xs text-on-surface-variant flex-1 truncate"
    }, NUTRIENT_LABELS[k]), /*#__PURE__*/React.createElement("input", {
      type: "number",
      min: "0",
      step: "any",
      value: wizardNutrients[k] || "",
      onChange: e => setWizardNutrients(prev => ({
        ...prev,
        [k]: e.target.value === "" ? 0 : parseFloat(e.target.value) || 0
      })),
      "data-testid": `cf-${k}`,
  ...
  // ── Scanner modal ───────────────────────────────────────────────────────
  if (showScanner) {
    return /*#__PURE__*/React.createElement(CameraScanModal, {
